...
while True:
#    menu = input(f"1) {drinks[0]} {prices[0]}원 2) {drinks[1]} {prices[1]} 3) {drinks[2]} {prices[2]} 4) 주문종료 : ")
...
for i in range(len(drinks)):
    print(f"{drinks[i]} {prices[i]} {amounts[i]}잔 {prices[i]}원 * {amounts[i]}원")
#print(f"{drinks[0]} {prices[0]} {amounts[0]}잔 {prices[0]}원 * {amounts[0]}원")
#print(f"{drinks[1]} {prices[1]} {amounts[1]}잔 {prices[1]}원 * {amounts[1]}원")
#print(f"{drinks[2]} {prices[2]} {amounts[2]}잔 {prices[2]}원 * {amounts[2]}원")
